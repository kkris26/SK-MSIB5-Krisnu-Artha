...
<body>
      ...
      <div class="row">
        <div class="col-md-8 address-info">
          <div class="info box">
            <ul>
              <li>
                <span><i class="fas fa-map"></i> Address</span>California, TX
                70240
              </li>
              <li>
    ...
    <div id="bootcarousel" class="carousel slide animate_text carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-inner text-light carousel-zoom">
        <div class="item active">
          <div class="slider-thumb bg-fixed" style="background-image: url(assets/img/bg1.webp)"></div>
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="content">
                      ...
                      <a data-animation="animated slideInUp" class="btn btn-theme effect btn-md" href="#popular-courses">View Courses</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="item">
          <div class="slider-thumb bg-fixed" style="background-image: url(assets/img/bg3.webp)"></div>
          <div class="box-table shadow dark">
            <div class="box-cell">
              <div class="container">
                <div class="row">
        ...
        <div class="item">
          <div class="slider-thumb bg-fixed" style="background-image: url(assets/img/bg4.webp)"></div>
          <div class="box-table shadow dark">
            <div class="box-cell">
              <div class="container">
                <div class="row">
                  <div class="col-md-8">
                    <div class="content">
                      ...
                      <h1 data-animation="animated slideInUp">
                        Join the bigest comunity of Examin
                      </h1>
                      <a data-animation="animated slideInUp" class="btn btn-light border btn-md" href="#">Learn more</a>
                      <a data-animation="animated slideInUp" class="btn btn-theme effect btn-md" href="#popular-courses">View Courses</a>
                    </div>
      ...
      <div class="row">
        <div class="about-info">
          <div class="col-md-6 thumb">
            <img src="assets/img/bg5.webp" alt="Thumb" height="600px" />
          </div>
          <div class="col-md-6 info">
            <h5>Introduction</h5>
            <h2>Welcome to the beigest online learning source of Examin</h2>
            <p>
              ...
              herself forming charmed amiable. Him why feebly expect future
              now.
            </p>
            <p>
          ...
          <div class="popular-courses-items popular-courses-carousel owl-carousel owl-theme">
            ...
            ?>
              ...
              <div class="item">
                <div class="thumb">
                  <a href="#">
                    <img src="imgKelas/<?php echo $image ?>" alt="Thumb" />
                  </a>
                  <div class="label">
                    <div class="level <?php echo $bg_level ?>"><?php echo $level ?></div>
                    <div class="price">Rp. <?php echo $harga_kelas ?></div>
                  </div>
                </div>
                <div class="info">
                  <div class="author-info">
                    <div class="thumb">
                      <a href="#"><img src="profilePengajar/<?php echo $foto_profile ?>" alt="Thumb" /></a>
                    </div>
                    <div class="others">
                      <a href="#"><?php echo $pengajar ?></a>
                  ...
                  <h4><a href="#"><?php echo $nama_kelas ?></a></h4>
                  <p class="deskripsi-kelas">
                    <?php echo $deskripsi ?>
                  </p>
                  <div class="bottom-info">
                    <ul>
                      <li><i class="fas fa-clock"></i> <?php echo $total_pertemuan . " Pertemuan" ?></li>
                    </ul>
                    <a href="#">Enroll Now</a>
                  </div>
                </div>
  ...
  <div id="top-categories" class="top-cat-area default-padding bottom-less">
    <div class="container">
      ...
      <div class="row">
        <div class="top-cat-items">
          ...
          <?php
          include "koneksi.php";
          // Query untuk mengambil jumlah kelas dalam setiap kategori
          $queryKategori = "SELECT kategori.nama_kategori, COUNT(kelas.id_kelas) AS jumlah_kelas, kategori.icon_kategori, kategori.bg_kategori FROM kategori LEFT JOIN kelas ON kategori.id_kategori = kelas.id_kategori GROUP BY kategori.id_kategori, kategori.nama_kategori, kategori.icon_kategori, kategori.bg_kategori";
          ...
          <div class="top-cat-items">
            ...
            while ($resultKategori = mysqli_fetch_array($sqlKategori)) {
              ...
              $jumlah_kelas = $resultKategori['jumlah_kelas'];
              $icon_kategori = $resultKategori['icon_kategori'];
                ...
                <div class="item" style="background-image: url(imgKategori/bgKategori/<?php echo $bg_kategori ?>)">
                  <a href="#">
                    ...
                    <div class="info">
                      ...
                      <span>(<?php echo $jumlah_kelas ?>) Topics</span>
                    </div>
                  </a>
                </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="advisor-items advisor-carousel-solid owl-carousel owl-theme text-center text-light">
              ...
              while ($resultPengajar = mysqli_fetch_array($sqlPengajar)) {
                ...
                $foto_profile_pengajar = $resultPengajar['foto_profile'];
              ...
              ?>
                ...
                <div class="advisor-item">
                  <div class="info-box">
                    <img src="profilePengajar/<?php echo $foto_profile_pengajar ?>" alt="Thumb" />
                    <div class="info-title">
                      <h4><?php echo $nama_pengajar ?></h4>
                      <span><?php echo $pengalaman_pengajar ?></span>
                      <div class="social">
                        <ul>
                          <li class="email">
                            <a href="mailto:<?php echo $email_pengajar ?>"><i class="fas fa-envelope"></i></a>
                          </li>
                          </li>
                        </ul>
                      </div>
    ...
    <!-- Start Fun Factor 
    ============================================= -->
    <div class="fun-factor-area default-padding bottom-less text-center bg-fixed shadow dark-hard" style="background-image: url(assets/img/bg7.webp)">
      <div class="container">
        <div class="row">
            ...
            <div class="clients-review-carousel owl-carousel owl-theme">
              ...
              <div class="item">
                <div class="col-md-5 thumb">
                  <img src="assets/img/student1.webp" alt="Thumb" />
                </div>
              ...
              <div class="item">
                <div class="col-md-5 thumb">
                  <img src="assets/img/student2.webp" alt="Thumb" />
                </div>
                <div class="col-md-7 info">
                  <p>
                    Procuring continued suspicion its ten. Pursuit brother are
              ...
              <div class="item">
                <div class="col-md-5 thumb">
                  <img src="assets/img/student3.webp" alt="Thumb" />
                </div>
                <div class="col-md-7 info">
                  <p>
                    Procuring continued suspicion its ten. Pursuit brother are
              ...
              <div class="item">
                <div class="col-md-5 thumb">
                  <img src="assets/img/student4.webp" alt="Thumb" />
                </div>
                <div class="col-md-7 info">
                  <p>
                    Procuring continued suspicion its ten. Pursuit brother are
              ...
              <div class="f-item address">
                ...
                <ul>
                  <li>
                    ...
                    <p>
                      Email
                      <span><a href="mailto:support@validtheme.com">support@validtheme.com</a></span>
                    </p>
                  </li>
                  <li>
